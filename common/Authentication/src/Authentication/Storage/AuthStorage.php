<?php
//filename : module/Authentication/src/Authentication/Storage/AuthStorage.php
    ...
    implements ServiceLocatorAwareInterface
{
    ...
    {
        $tableGateway = new TableGateway('sessions', $this->getServiceLocator()->get('Zend\Db\Adapter\Adapter'));
