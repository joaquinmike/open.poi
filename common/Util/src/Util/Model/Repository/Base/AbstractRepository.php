...
abstract class AbstractRepository implements ServiceLocatorAwareInterface
{
     ...
     */
    public $sql;
    protected $_edicionId;
    protected $_idioma;
    public $_service;


    public function __construct(Adapter $adapter, $service) 
    {        
        $this->_service = $service;
        $this->sql = new Sql($adapter);
        $this->adapter = $adapter;
        
        $edicionSession = new \Zend\Session\Container('edicionSession');
        $this->_edicionId = $edicionSession->edicion['id'];
        
        $langSession = new \Zend\Session\Container(\Util\Controller\Plugin\Lang::SESSION_NAME);
        $this->_idioma = $langSession->idioma;
