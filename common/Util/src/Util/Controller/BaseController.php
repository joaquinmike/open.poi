...
abstract class BaseController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    {
        $data = array();
        $data[] = \Util\Util\Util::stripTags($this->params()->fromRoute());
        $data[] = \Util\Util\Util::stripTags($this->params()->fromPost());
        $data[] = \Util\Util\Util::stripTags($this->params()->fromQuery());
        $params = \Util\Util\Util::mergeParams($data);
        return $params;
    }
