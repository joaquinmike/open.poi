...
return array(
    ...
    "The input must contain only digits" => "'%value%' debe contener sólo dígitos",

    // Zend_Validate_EmailAddress
    "Invalid type given, value should be a string" => "El tipo especificado no es válido, el valor debe ser una cadena de texto",
    "The input is not a valid email address. Use the basic format local-part@hostname" => " '%value%' no es una dirección de correo electrónico válida.",
    "'%hostname%' is not a valid hostname for the email address" => "'%hostname%' no es un nombre de host válido para la dirección de correo electrónico '%value%'",
    ...
    "'%localPart%' can not be matched against dot-atom format" => "'%localPart%' no es igual al formato requerido.",
    "'%localPart%' can not be matched against quoted-string format" => "'%localPart%' no es igual al formato requerido.",
    "'%localPart%' is not a valid local part for the email address" => "'%localPart%' no es una parte local válida para la dirección de correo electrónico.",
    ...
    "All files in sum should have a minimum size of '%min%' but '%size%' were detected" => "Todos los archivos deberían tener un tamaño mí­nimo de '%min%' pero tiene un tamaño de '%size%'",
    ...
    "Maximum allowed width for image '%value%' should be '%maxwidth%' but '%width%' detected" => "El ancho máxima para la imagen '%value%' debería ser '%maxwidth%' pero es de '%width%'",
    "Minimum expected width for image '%value%' should be '%minwidth%' but '%width%' detected" => "El ancho mí­nima para la imagen '%value%' debería ser '%minwidth%' pero es de '%width%'",
    "Maximum allowed height for image '%value%' should be '%maxheight%' but '%height%' detected" => "La altura máxima para la imagen '%value%' debería ser '%maxheight%' pero es de '%height%'",
    "Minimum expected height for image '%value%' should be '%minheight%' but '%height%' detected" => "La altura mí­nima para la imagen '%value%' debería ser '%minheight%' pero es de '%height%'",
...
// Zend_Validate_GreaterThan
    ...
    "The input appears to be a DNS hostname but cannot match TLD against known list" => " La entrada parece ser un nombre de host DNS, pero no puede coincidir con la lista conocida TLD.",
    "The input appears to be a local network name but local network names are not allowed" => " La entrada parece ser un nombre de red local, pero los nombres de red locales no son permitidos.",
    ...
    "The input is less than %min% characters long" => "'%value%' tiene menos de '%min%' caracteres.",
